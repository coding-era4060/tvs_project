def offers(result_frame):
    ...
    global tvs_logo
    tvs_image_location = os.path.abspath('../tvs_project/tvs_offer.jpg')
    opened_image = Image.open(tvs_image_location)
    resize_image = opened_image.resize((750, 334))
    tvs_logo = ImageTk.PhotoImage(resize_image)
    lbl_name.image_create("insert", image=tvs_logo, padx=250)
    about_word_file_location = os.path.abspath('../tvs_project/WORD_files/TVS_offer.docx')
